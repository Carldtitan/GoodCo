...
describe("marketplace transfer finalization boundary", () => {
  it("sends source, destination, quantity, and cold-chain fields only through the transfer RPC", () => {
    const input = transferSchema.parse({ listingId: "00000000-0000-4000-8000-000000000001", requestId: "00000000-0000-4000-8000-000000000002", sourceLotId: "00000000-0000-4000-REDACTED", sourcePantryId: "00000000-0000-4000-8000-000000000004", destinationPantryId: "00000000-0000-4000-8000-000000000005", quantity: 2, unit: "case", temperatureAtReceipt: 4 });
